...
public class PfsStorage_Controller {
    ...
    @GetMapping
    public List<PfsStorage_Entity> getAll() { return service.getAll(); }

    @PostMapping
    public PfsStorage_Entity add(@RequestBody PfsStorage_Entity obj) { return service.save(obj); }

    @PutMapping("/{id}")
    public PfsStorage_Entity update(@PathVariable Long id, @RequestBody PfsStorage_Entity obj) {
        obj.setId(id);
